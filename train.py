...
from model import *
# sys.argv = ['train.py'] 在jupyter notebook环境下训练
...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="D:/Graduation Project/DATA/LICENSE_REC_DATA/SAMLL_DATA/train/", help='the train images path')
    parser.add_argument('--test_img_dirs', default="D:/Graduation Project/DATA/LICENSE_REC_DATA/SAMLL_DATA/test/", help='the test images path')
    parser.add_argument('--dropout_rate', default=0.7, help='dropout rate.')
...
def test():
    ...
    lprnet.load_state_dict(torch.load('../weights/LPRNET.pth', map_location=torch.device(0)))
    print("****************lprnet模型加载完成****************")
